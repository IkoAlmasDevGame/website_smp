    ...
    <div id="layoutAuthentication">
        <div id="layoutAuthentication_content">
            <main>
                    ...
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <div class="container-fluid mt-2 flex justify-end items-center">
                                <form action="" method="post" class="flex" style="margin-left:60rem;">
                                ...
                                if(isset($_GET["pesan"])){
                                    if($_GET["pesan"] == ""){
                                        ...
                                        <div class="card-title text-center fw-noraml">
                                            <h5 class="card-title">
                                                <span class="fas fa-check"></span> Berhasil Dibuat </h5>
                                        </div>
                                        <?php
                                    }else if($_GET["pesan"] == ""){
                                        ?>
                                        <div class="card-title text-center fw-noraml">
                                            <h5 class="card-title">
                                                <span class="fas fa-close"></span> Gagal Dibuat </h5>
                                        </div>
                                        <?php
                                    }
                                    ?>
                                ...
                                <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="userEmail" id="InputEmail" class="form-control input" placeholder="Masukkan Email Anda disini ...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="username" id="InputName" class="form-control input" placeholder="Masukkan username Anda disini ...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="password" id="InputPassword" class="form-control input" placeholder="Masukkan Password Baru disini ...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="modal-footer mt-10">
                                            <button class="btn btn-primary" name="" type="submit" role="button" onclick="form.clean();">
                ...
                <div class="flex justify-end items-center fixed-top mt-52 mr-80">
